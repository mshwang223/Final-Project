...
**사용자** : 서로간의 친목 교류 및 찾고자 하는 서비스를 손쉽게 검색



##### 1. 애완인들의 친목 교류 및 정보 교류 공간을 제공한다.

- 사용자들에게 가까운 지역이나 같은 지역에 진행하는 모임 및 행사를 따로 보여준다. 

  

##### 2. 사용자들이 사이트를 이용하는데 어려움이나 고충을 운영자에게 개인적으로 게시하거나 공유할 수 있는 공간을 제공한다.
